            ...
            with gr.Row():
                with gr.Column():
                    with gr.Row():
                        ...
                        shared.gradio["save_preset"] = gr.Button(
                            "💾", elem_classes="refresh-button", interactive=not mu
                        )
                        shared.gradio["delete_preset"] = gr.Button(
                            "🗑️", elem_classes="refresh-button", interactive=not mu
                        )
                        shared.gradio["reset_preset"] = gr.Button(
                            "Restore preset",
                            elem_classes="refresh-button",
                            interactive=True,
                        )
                        shared.gradio["neutralize_samplers"] = gr.Button(
                            "Neutralize samplers",
                            elem_classes="refresh-button",
                            interactive=True,
                        )
                ...
                with gr.Column():
                    shared.gradio["filter_by_loader"] = gr.Dropdown(
                        ...
                        choices=(
                            ["All"] + list(loaders.loaders_and_params.keys())
                    ...
                    with gr.Row():
                        with gr.Column():
                            ...
                            shared.gradio["temperature"] = gr.Slider(
                                0.01,
                                5,
                                value=shared.settings["temperature"],
                                step=0.01,
                                label="temperature",
                            )
                            shared.gradio["dynatemp_low"] = gr.Slider(
                                0.01,
                                5,
                                value=shared.settings["dynatemp_low"],
                                step=0.01,
                                label="dynatemp_low",
                                visible=shared.settings["dynamic_temperature"],
                            )
                            shared.gradio["dynatemp_high"] = gr.Slider(
                                0.01,
                                5,
                                value=shared.settings["dynatemp_high"],
                                step=0.01,
                                label="dynatemp_high",
                                visible=shared.settings["dynamic_temperature"],
                            )
                            shared.gradio["dynatemp_exponent"] = gr.Slider(
                                0.01,
                                5,
                                value=shared.settings["dynatemp_exponent"],
                                step=0.01,
                                label="dynatemp_exponent",
                                visible=shared.settings["dynamic_temperature"],
                            )
                            shared.gradio["smoothing_factor"] = gr.Slider(
                                0.0,
                                10.0,
                                value=shared.settings["smoothing_factor"],
                                step=0.01,
                                label="smoothing_factor",
                                info="Activates Quadratic Sampling.",
                            )
                            shared.gradio["smoothing_curve"] = gr.Slider(
                                1.0,
                                10.0,
                                value=shared.settings["smoothing_curve"],
                                step=0.01,
                                label="smoothing_curve",
                                info="Adjusts the dropoff curve of Quadratic Sampling.",
                            )
                            shared.gradio["dynamic_temperature"] = gr.Checkbox(
                                value=shared.settings["dynamic_temperature"],
                                label="dynamic_temperature",
                            )

                            gr.Markdown("## Curve cutoff")
                            shared.gradio["min_p"] = gr.Slider(
                                0.0,
                                1.0,
                                value=shared.settings["min_p"],
                                step=0.01,
                                label="min_p",
                            )
                            shared.gradio["top_n_sigma"] = gr.Slider(
                                0.0,
                                5.0,
                                value=shared.settings["top_n_sigma"],
                                step=0.01,
                                label="top_n_sigma",
                            )
                            ...
                            shared.gradio["typical_p"] = gr.Slider(
                                0.0,
                                1.0,
                                value=shared.settings["typical_p"],
                                step=0.01,
                                label="typical_p",
                            )
                            shared.gradio["xtc_threshold"] = gr.Slider(
                                0,
                                0.5,
                                value=shared.settings["xtc_threshold"],
                                step=0.01,
                                label="xtc_threshold",
                                info="If 2 or more tokens have probability above this threshold, consider removing all but the last one.",
                            )
                            shared.gradio["xtc_probability"] = gr.Slider(
                                0,
                                1,
                                value=shared.settings["xtc_probability"],
                                step=0.01,
                            ...
                            shared.gradio["epsilon_cutoff"] = gr.Slider(
                                0,
                                9,
                                value=shared.settings["epsilon_cutoff"],
                                step=0.01,
                            ...
                            shared.gradio["eta_cutoff"] = gr.Slider(
                                0,
                                20,
                                value=shared.settings["eta_cutoff"],
                                step=0.01,
                                label="eta_cutoff",
                            )
                            ...
                            shared.gradio["top_a"] = gr.Slider(
                                0.0,
                                1.0,
                                value=shared.settings["top_a"],
                                step=0.01,
                                label="top_a",
                            )

                            gr.Markdown("## Repetition suppression")
                            shared.gradio["dry_multiplier"] = gr.Slider(
                                0,
                                5,
                                value=shared.settings["dry_multiplier"],
                                step=0.01,
                                label="dry_multiplier",
                                info="Set to greater than 0 to enable DRY. Recommended value: 0.8.",
                            )
                            shared.gradio["dry_allowed_length"] = gr.Slider(
                                1,
                                20,
                                value=shared.settings["dry_allowed_length"],
                                step=1,
                                label="dry_allowed_length",
                                info="Longest sequence that can be repeated without being penalized.",
                            )
                            shared.gradio["dry_base"] = gr.Slider(
                                1,
                                4,
                                value=shared.settings["dry_base"],
                                step=0.01,
                                label="dry_base",
                            ...
                            shared.gradio["repetition_penalty"] = gr.Slider(
                                1.0,
                                1.5,
                                value=shared.settings["repetition_penalty"],
                                step=0.01,
                            ...
                            shared.gradio["frequency_penalty"] = gr.Slider(
                                0,
                                2,
                                value=shared.settings["frequency_penalty"],
                                step=0.05,
                            ...
                            shared.gradio["presence_penalty"] = gr.Slider(
                                0,
                                2,
                                value=shared.settings["presence_penalty"],
                                step=0.05,
                            ...
                            shared.gradio["encoder_repetition_penalty"] = gr.Slider(
                                0.8,
                                1.5,
                                value=shared.settings["encoder_repetition_penalty"],
                                step=0.01,
                            ...
                            shared.gradio["no_repeat_ngram_size"] = gr.Slider(
                                ...
                                20,
                                step=1,
                                value=shared.settings["no_repeat_ngram_size"],
                            ...
                            shared.gradio["repetition_penalty_range"] = gr.Slider(
                                ...
                                4096,
                                step=64,
                                value=shared.settings["repetition_penalty_range"],
                        ...
                        with gr.Column():
                            ...
                            shared.gradio["penalty_alpha"] = gr.Slider(
                                0,
                                5,
                                value=shared.settings["penalty_alpha"],
                                label="penalty_alpha",
                                info="For Contrastive Search. do_sample must be unchecked.",
                            )
                            shared.gradio["guidance_scale"] = gr.Slider(
                                -0.5,
                                2.5,
                                step=0.05,
                                value=shared.settings["guidance_scale"],
                            ...
                            shared.gradio["mirostat_mode"] = gr.Slider(
                                ...
                                2,
                                step=1,
                                value=shared.settings["mirostat_mode"],
                                label="mirostat_mode",
                            ...
                            shared.gradio["mirostat_tau"] = gr.Slider(
                                ...
                                10,
                                step=0.01,
                                value=shared.settings["mirostat_tau"],
                                label="mirostat_tau",
                            )
                            shared.gradio["mirostat_eta"] = gr.Slider(
                                ...
                                1,
                                step=0.01,
                                value=shared.settings["mirostat_eta"],
                                label="mirostat_eta",
                            )

                            gr.Markdown("## Other options")
                            shared.gradio["do_sample"] = gr.Checkbox(
                                value=shared.settings["do_sample"], label="do_sample"
                            )
                            shared.gradio["temperature_last"] = gr.Checkbox(
                                value=shared.settings["temperature_last"],
                            ...
                            shared.gradio["sampler_priority"] = gr.Textbox(
                                value=shared.settings["sampler_priority"],
                                lines=10,
                            ...
                            shared.gradio["dry_sequence_breakers"] = gr.Textbox(
                                value=shared.settings["dry_sequence_breakers"],
                    ...
                    with gr.Row():
                        with gr.Column():
                            ...
                            shared.gradio["add_bos_token"] = gr.Checkbox(
                                ...
                                info="Only applies to text completion (notebook). In chat mode, templates control BOS tokens.",
                            )
                        ...
                        with gr.Column():
                            ...
                            shared.gradio["custom_system_message"] = gr.Textbox(
                                value=shared.settings["custom_system_message"],
                                lines=2,
                                label="Custom system message",
                                info="If not empty, will be used instead of the default one.",
                                elem_classes=["add_scrollbar"],
                            )
                            ...
                            with gr.Row() as shared.gradio["grammar_file_row"]:
                                ...
                                shared.gradio["save_grammar"] = gr.Button(
                                    "💾",
                                    elem_classes="refresh-button",
                                    interactive=not mu,
                                )
                                shared.gradio["delete_grammar"] = gr.Button(
                                    "🗑️ ",
                                    elem_classes="refresh-button",
                                    interactive=not mu,
                                )
                            ...
                            shared.gradio["grammar_string"] = gr.Textbox(
                                value=shared.settings["grammar_string"],
                                label="Grammar",
                                lines=16,
...
def create_event_handlers():
    ...
    shared.gradio["neutralize_samplers"].click(
        ...
        presets.neutralize_samplers_for_ui,
        gradio("interface_state"),
        gradio("interface_state") + gradio(presets.presets_params()),
        show_progress=False,
    )
...
def get_truncation_length():
    if (
        "ctx_size" in shared.provided_arguments
        or shared.args.ctx_size != shared.args_defaults.ctx_size
    ):
