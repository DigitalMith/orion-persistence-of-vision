    ...
    def __init__(self, logit_bias={}):
        ...
        if self.logit_bias:
            ...
            self.values = torch.tensor(
                values, dtype=torch.float, device=shared.model.device
            )
    ...
    def __call__(
        ...
        if self.logprobs is not None:  # 0-5
            ...
            top_values, top_indices = torch.topk(
                log_e_probabilities, k=self.logprobs + 1
            )
...
def load_model_HF(model_name):
    ...
    config = AutoConfig.from_pretrained(
        path_to_model, trust_remote_code=shared.original_args.trust_remote_code
    )
    ...
    # Load with quantization and/or offloading
            ...
            if shared.args.load_in_4bit:
                ...
                quantization_config_params = {
                    ...
                    "bnb_4bit_compute_dtype": (
                        eval(f"torch.{shared.args.compute_dtype}")
        ...
        if shared.args.compress_pos_emb > 1:
            ...
            params["rope_scaling"] = {
                "type": "dynamic",
                "factor": shared.args.alpha_value,
            }
