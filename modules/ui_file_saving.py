...
def create_ui():
    ...
    # Text file saver
    with gr.Group(visible=False, elem_classes="file-saver") as shared.gradio[
        "file_saver"
    ]:
        ...
        with gr.Row():
            shared.gradio["save_cancel"] = gr.Button(
    ...
    with gr.Group(visible=False, elem_classes="file-saver") as shared.gradio[
        ...
        with gr.Row():
            shared.gradio["delete_cancel"] = gr.Button(
                "Cancel", elem_classes="small-button"
            )
    ...
    with gr.Group(visible=False, elem_classes="file-saver") as shared.gradio[
        ...
        shared.gradio["save_character_filename"] = gr.Textbox(
            lines=1,
            label="File name",
            info="The character will be saved to your user_data/characters folder with this base filename.",
        )
        with gr.Row():
    ...
    with gr.Group(visible=False, elem_classes="file-saver") as shared.gradio[
        ...
        shared.gradio["save_preset_filename"] = gr.Textbox(
            lines=1,
            label="File name",
            info="The preset will be saved to your user_data/presets folder with this base filename.",
        )
        shared.gradio["save_preset_contents"] = gr.Textbox(
            lines=10, label="File contents"
        )
        with gr.Row():
            shared.gradio["save_preset_cancel"] = gr.Button(
                "Cancel", elem_classes="small-button"
            )
            shared.gradio["save_preset_confirm"] = gr.Button(
                "Save",
                elem_classes="small-button",
                variant="primary",
                interactive=not mu,
...
def create_event_handlers():
    shared.gradio["save_preset"].click(
        ...
        gradio("interface_state"),
        gradio("save_preset_contents", "save_preset_filename", "preset_saver"),
        show_progress=False,
    )
    ...
    shared.gradio["save_preset_confirm"].click(
        ...
        gradio("preset_menu", "preset_saver"),
        show_progress=False,
    )
    ...
    shared.gradio["delete_confirm"].click(
        ...
        gradio("delete_root", "delete_filename"),
        gradio("file_deleter"),
        show_progress=False,
    )
    ...
    shared.gradio["delete_character_confirm"].click(
        ...
        gradio("character_menu", "character_deleter"),
        show_progress=False,
    )

    shared.gradio["save_preset_cancel"].click(
        lambda: gr.update(visible=False),
        None,
        gradio("preset_saver"),
        show_progress=False,
    )
    shared.gradio["save_cancel"].click(
...
def handle_save_character_confirm_click(
    name2, greeting, context, character_picture, filename
):
    try:
...
def handle_delete_preset_click(preset):
    return [f"{preset}.yaml", "user_data/presets/", gr.update(visible=True)]
...
def handle_delete_grammar_click(grammar_file):
    return [grammar_file, "user_data/grammars/", gr.update(visible=True)]
