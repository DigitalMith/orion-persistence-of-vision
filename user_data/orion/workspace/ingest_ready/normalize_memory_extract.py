...
from orion_cli.settings.config_loader import get_config  # ensure config loads
...
def annotate_chunk_with_nemo(text: str, source_label: str = "", nemo_path: Optional[Path] = None) -> Optional[dict]:
    """
...
"""
    ...
    try:
        ...
        print("[NEMO] WARN: Invalid JSON from Nemo, skipping annotation for this chunk.")
        return None
